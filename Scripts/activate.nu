...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\comrades\PycharmProjects\pythonProject\Client Server communication project'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\comrades\PycharmProjects\pythonProject\Client Server communication project\Scripts\deactivate.nu'
